...
const GsapTimeline = () => {
  ...
  useGSAP(() => {
    timeline.to("#yellow-box", { x: 250, borderRadius: '100%', rotate: 360, duration: 2, ease: 'back.inOut'})
    timeline.to("#yellow-box", { y: 150, borderRadius: '100%', rotate: 360, duration: 2, ease: 'back.inOut'})
    timeline.to("#yellow-box", { x: 500, borderRadius: '100%', rotate: 360, duration: 2, ease: 'back.inOut'})
  },[])
